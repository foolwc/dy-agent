...
package com.hust.foolwc.dy.agent.log4j;

import com.hust.foolwc.dy.agent.log4j.message.ParameterizedMessage;
import com.hust.foolwc.dy.agent.log4j.spi.CleanableThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.CopyOnWriteSortedArrayThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.DefaultThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.DefaultThreadContextStack;
import com.hust.foolwc.dy.agent.log4j.spi.GarbageFreeSortedArrayThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.NoOpThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.ReadOnlyThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.ThreadContextMap;
import com.hust.foolwc.dy.agent.log4j.spi.ThreadContextMap2;
import com.hust.foolwc.dy.agent.log4j.spi.ThreadContextMapFactory;
import com.hust.foolwc.dy.agent.log4j.spi.ThreadContextStack;
...
public final class ThreadContext {
     ...
     * @see CopyOnWriteSortedArrayThreadContextMap
     * @see GarbageFreeSortedArrayThreadContextMap
     * @since 2.8
     */

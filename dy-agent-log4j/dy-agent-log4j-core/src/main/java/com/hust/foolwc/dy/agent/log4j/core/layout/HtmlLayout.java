...
import com.hust.foolwc.dy.agent.log4j.core.util.Transform;
...
public final class HtmlLayout extends AbstractStringLayout {
    ...
    public static class Builder implements com.hust.foolwc.dy.agent.log4j.core.util.Builder<HtmlLayout> {

...
import com.hust.foolwc.dy.agent.log4j.core.config.ConfigurationFactory;
import com.hust.foolwc.dy.agent.log4j.core.config.ConfigurationListener;
import com.hust.foolwc.dy.agent.log4j.core.config.ConfigurationSource;
import com.hust.foolwc.dy.agent.log4j.core.config.DefaultConfiguration;
import com.hust.foolwc.dy.agent.log4j.core.config.NullConfiguration;
import com.hust.foolwc.dy.agent.log4j.core.config.Reconfigurable;
import com.hust.foolwc.dy.agent.log4j.core.impl.Log4jLogEvent;
import com.hust.foolwc.dy.agent.log4j.core.jmx.Server;
import com.hust.foolwc.dy.agent.log4j.core.util.Cancellable;
import com.hust.foolwc.dy.agent.log4j.core.util.ExecutorServices;
import com.hust.foolwc.dy.agent.log4j.core.util.NetUtils;
import com.hust.foolwc.dy.agent.log4j.core.util.ShutdownCallbackRegistry;
import com.hust.foolwc.dy.agent.log4j.message.MessageFactory;
import com.hust.foolwc.dy.agent.log4j.spi.AbstractLogger;
import com.hust.foolwc.dy.agent.log4j.spi.LoggerContextFactory;
import com.hust.foolwc.dy.agent.log4j.spi.LoggerRegistry;
import com.hust.foolwc.dy.agent.log4j.spi.Terminable;
...
import static com.hust.foolwc.dy.agent.log4j.core.util.ShutdownCallbackRegistry.SHUTDOWN_HOOK_MARKER;
...
public class LoggerContext extends AbstractLifeCycle
        implements com.hust.foolwc.dy.agent.log4j.spi.LoggerContext, AutoCloseable, Terminable, ConfigurationListener {
                ...
                try {
                    ...
                    this.shutdownCallback = ((ShutdownCallbackRegistry) factory).addShutdownCallback(new Runnable() {
                        ...
                        public void run() {
                            ...
                            LOGGER.debug(ShutdownCallbackRegistry.SHUTDOWN_HOOK_MARKER, "Stopping LoggerContext[name={}, {}]",
                    ...
                    LOGGER.error(ShutdownCallbackRegistry.SHUTDOWN_HOOK_MARKER, "Unable to register shutdown hook due to security restrictions",
                            e);
                }
            }
        }
    ...
    private void reconfigure(final URI configURI) {
        ...
        final Configuration instance = ConfigurationFactory
                .getInstance().getConfiguration(this, contextName, configURI, cl);
        if (instance == null) {

...
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.DefaultRolloverStrategy;
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.DirectFileRolloverStrategy;
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.DirectWriteRolloverStrategy;
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.RollingRandomAccessFileManager;
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.RolloverStrategy;
import com.hust.foolwc.dy.agent.log4j.core.appender.rolling.TriggeringPolicy;
...
import com.hust.foolwc.dy.agent.log4j.core.util.Booleans;
...
public final class RollingRandomAccessFileAppender extends AbstractOutputStreamAppender<RollingRandomAccessFileManager> {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements com.hust.foolwc.dy.agent.log4j.core.util.Builder<RollingRandomAccessFileAppender> {

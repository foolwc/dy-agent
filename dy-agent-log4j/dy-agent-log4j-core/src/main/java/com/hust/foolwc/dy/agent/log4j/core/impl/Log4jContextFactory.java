 ...
 */
package com.hust.foolwc.dy.agent.log4j.core.impl;

import com.hust.foolwc.dy.agent.log4j.core.LifeCycle;
import com.hust.foolwc.dy.agent.log4j.core.LoggerContext;
import com.hust.foolwc.dy.agent.log4j.core.config.AbstractConfiguration;
...
import com.hust.foolwc.dy.agent.log4j.core.selector.ClassLoaderContextSelector;
import com.hust.foolwc.dy.agent.log4j.core.selector.ContextSelector;
import com.hust.foolwc.dy.agent.log4j.core.util.Cancellable;
import com.hust.foolwc.dy.agent.log4j.core.util.Constants;
import com.hust.foolwc.dy.agent.log4j.core.util.DefaultShutdownCallbackRegistry;
...
public class Log4jContextFactory implements LoggerContextFactory, ShutdownCallbackRegistry {
     ...
     */
    @Override
    public void removeContext(final com.hust.foolwc.dy.agent.log4j.spi.LoggerContext context) {

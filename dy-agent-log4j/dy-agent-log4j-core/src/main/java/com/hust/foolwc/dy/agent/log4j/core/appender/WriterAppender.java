...
import com.hust.foolwc.dy.agent.log4j.core.util.CloseShieldWriter;
/**
...
public final class WriterAppender extends AbstractWriterAppender<WriterManager> {
     ...
     */
    public static class Builder implements com.hust.foolwc.dy.agent.log4j.core.util.Builder<WriterAppender> {

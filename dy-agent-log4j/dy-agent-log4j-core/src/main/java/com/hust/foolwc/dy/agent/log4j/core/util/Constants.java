 ...
 */
package com.hust.foolwc.dy.agent.log4j.core.util;


import com.hust.foolwc.dy.agent.log4j.util.PropertiesUtil;

import com.hust.foolwc.dy.agent.log4j.core.layout.ByteBufferDestination;
...
public final class Constants {
     ...
     */
    public static final boolean IS_WEB_APP = com.hust.foolwc.dy.agent.log4j.util.Constants.IS_WEB_APP;
     ...
     * @since 2.6
     */
    public static final boolean ENABLE_THREADLOCALS = com.hust.foolwc.dy.agent.log4j.util.Constants.ENABLE_THREADLOCALS;

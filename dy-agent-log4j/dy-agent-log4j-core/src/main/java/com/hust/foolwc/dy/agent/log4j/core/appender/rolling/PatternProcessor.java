...
import com.hust.foolwc.dy.agent.log4j.core.pattern.ArrayPatternConverter;
import com.hust.foolwc.dy.agent.log4j.core.pattern.DatePatternConverter;
import com.hust.foolwc.dy.agent.log4j.core.pattern.FormattingInfo;
import com.hust.foolwc.dy.agent.log4j.core.pattern.PatternConverter;
...
import com.hust.foolwc.dy.agent.log4j.Logger;
import com.hust.foolwc.dy.agent.log4j.core.LogEvent;
import com.hust.foolwc.dy.agent.log4j.core.impl.Log4jLogEvent.Builder;
import com.hust.foolwc.dy.agent.log4j.core.lookup.StrSubstitutor;
import com.hust.foolwc.dy.agent.log4j.core.pattern.ArrayPatternConverter;
import com.hust.foolwc.dy.agent.log4j.core.pattern.DatePatternConverter;
import com.hust.foolwc.dy.agent.log4j.core.pattern.FormattingInfo;
...
public class PatternProcessor {
    ...
    public final void formatFileName(final StrSubstitutor subst, final StringBuilder buf, final boolean useCurrentTime,
        ...
        formatFileName(buf, new Date(time), obj);
        final LogEvent event = new Builder().setTimeMillis(time).build();

...
import com.hust.foolwc.dy.agent.log4j.core.ContextDataInjector;
import com.hust.foolwc.dy.agent.log4j.core.LogEvent;
import com.hust.foolwc.dy.agent.log4j.core.async.RingBufferLogEvent;
import com.hust.foolwc.dy.agent.log4j.core.config.LoggerConfig;
import com.hust.foolwc.dy.agent.log4j.core.config.Property;
import com.hust.foolwc.dy.agent.log4j.core.util.Clock;
import com.hust.foolwc.dy.agent.log4j.core.util.ClockFactory;
import com.hust.foolwc.dy.agent.log4j.core.util.DummyNanoClock;
import com.hust.foolwc.dy.agent.log4j.core.util.NanoClock;
import com.hust.foolwc.dy.agent.log4j.message.LoggerNameAwareMessage;
import com.hust.foolwc.dy.agent.log4j.message.Message;
import com.hust.foolwc.dy.agent.log4j.message.ReusableMessage;
import com.hust.foolwc.dy.agent.log4j.message.SimpleMessage;
import com.hust.foolwc.dy.agent.log4j.message.TimestampMessage;
import com.hust.foolwc.dy.agent.log4j.status.StatusLogger;
import com.hust.foolwc.dy.agent.log4j.util.ReadOnlyStringMap;
import com.hust.foolwc.dy.agent.log4j.util.StackLocatorUtil;
import com.hust.foolwc.dy.agent.log4j.util.StringMap;
...
import com.hust.foolwc.dy.agent.log4j.core.config.LoggerConfig;
import com.hust.foolwc.dy.agent.log4j.core.config.Property;
import com.hust.foolwc.dy.agent.log4j.core.util.Builder;
import com.hust.foolwc.dy.agent.log4j.core.util.Clock;
import com.hust.foolwc.dy.agent.log4j.core.util.ClockFactory;
import com.hust.foolwc.dy.agent.log4j.core.util.DummyNanoClock;
import com.hust.foolwc.dy.agent.log4j.core.util.NanoClock;
...
public class Log4jLogEvent implements LogEvent {
    ...
    public static class Builder implements com.hust.foolwc.dy.agent.log4j.core.util.Builder<LogEvent> {

...
import com.hust.foolwc.dy.agent.log4j.core.config.builder.api.ConfigurationBuilderFactory;
import com.hust.foolwc.dy.agent.log4j.core.config.composite.CompositeConfiguration;
...
import com.hust.foolwc.dy.agent.log4j.core.util.FileUtils;
import com.hust.foolwc.dy.agent.log4j.core.util.NetUtils;
import com.hust.foolwc.dy.agent.log4j.core.util.ReflectionUtil;
 ...
 * {@linkplain com.hust.foolwc.dy.agent.log4j.core.config.xml.XmlConfigurationFactory} for an example.</li>
 * </ol>
 *
...
public abstract class ConfigurationFactory extends ConfigurationBuilderFactory {
     ...
     */
    public static final String CONFIGURATION_FACTORY_PROPERTY = "dy.agent.log4j.configurationFactory";

    /**
     * Allows the location of the configuration file to be specified as a system property.
     */
    public static final String CONFIGURATION_FILE_PROPERTY = "dy.agent.log4j.configurationFile";
     ...
     */
    protected static final String TEST_PREFIX = "dy-agent-log4j2-test";

    /**
     * File name prefix for standard configurations.
     */
    protected static final String DEFAULT_PREFIX = "dy-agent-log4j2";

...
import com.hust.foolwc.dy.agent.log4j.message.ObjectMessage;
...
public final class ScriptFilter extends AbstractFilter {
    ...
    private static com.hust.foolwc.dy.agent.log4j.Logger logger = StatusLogger.getLogger();
    ...
    @Override
    public Result filter(final com.hust.foolwc.dy.agent.log4j.core.Logger logger, final Level level, final Marker marker, final String msg,
                         final Object... params) {
